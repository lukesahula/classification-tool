  ...
  \section{Experiments}
    ...
    \subsection{Results}
      ...
      \subsubsection{Average overall precision}
        The first metric to look at is the overall precision. It is the precision in the form that was declared in at the beginning of this chapter. Looking at table [\ref{table:overall_prec}], it can be seen that the OTFI method does not bring any improvement compared to the baseline and its results are actually even weaker.
        \begin{table}
          \centering
          \caption{Average overall precision of the tested methods.}
          \label{table:overall_prec}
          \begin{tikzpicture}
            \begin{axis}[
                ybar,
                width=12cm,
                height=10cm,
                ylabel={Average overall precision},
      ...
      \subsubsection{Average overall precision without nans}
        ...
        \begin{table}
          ...
          \label{table:overall_prec_no_nan}
          \begin{tikzpicture}
            \begin{axis}[
                ybar,
                width=12cm,
                height=10cm,
                ylabel={Average overall precision without nans},
                symbolic x coords={Baseline, Mean, Median, Otfi, Mia},
                xtick=data,
                legend style={at={(0.5, -0.2)},
                  anchor=north,legend columns=-1},
      ...
      \subsubsection{Average overall precision without nans and the negative class}
        ...
        \begin{table}
          ...
          \label{table:overall_prec_no_nan_no_negative}
          \begin{tikzpicture}
            \begin{axis}[
                ybar,
                width=12cm,
                height=10cm,
                ylabel={Average overall precision without negative class and nans},
                symbolic x coords={Baseline, Mean, Median, Otfi, Mia},
                xtick=data,
                legend style={at={(0.5, -0.2)},
                  anchor=north,legend columns=-1},
      ...
      \subsubsection{Number of classes with precision above a certain threshold}
        ...
        \\~\\
        Because of that, it is good to look at the number of classes that were predicted with precision above some chosen threshold.
  \newpage
  \section*{Conclusion}
